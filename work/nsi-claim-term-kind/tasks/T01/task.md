...
- [x] Enum, entity, потребители константы
- [x] Changelog-и: `finish_note`, сид строк «повр»
- [x] Экраны и ключи i18n
- [x] Тесты и самопроверка
- [x] Передать результат на независимую проверку.
- [x] Независимая проверка пройдена ([checks/001.md](checks/001.md)).

Ближайший шаг: таск завершён, закрытие работы через task-close.
Препятствия: нет.
