...
- [x] XML: tabSheet с «Описанием» первой вкладкой, группы полей.
- [x] Контроллер: неактивные вкладки у нового, включение после сохранения.
- [x] Messages, UI-тест, contracts.md.
- [x] Самопроверка: compileJava, spotlessApply, UI-тесты, браузерный smoke C1.
- [x] Передать результат на независимую проверку —
      [result.md](result.md), итерация 1.
- [x] Независимая проверка пройдена — [checks/001.md](checks/001.md), `pass`.

Ближайший шаг: таск закрыт; по очереди plan.md следующий —
[T12](../T12/task.md).
Препятствия: нет
