...
- [ ] Проверить API аддона и наличие таблиц.
- [ ] Seed конфигурации и свойство.
- [ ] Фрагмент, меню, тесты.
- [ ] Передать результат на независимую проверку.

Ближайший шаг: после done T01 проверить `audit_*` таблицы в схеме и API
`io.jmix.audit.entity.*`.
