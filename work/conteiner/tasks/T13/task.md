...
- [ ] Освидетельствование: компоновка и видимость панели.
- [ ] Вкладка «Файлы»: компоновка и видимость панели.
- [ ] Карточка договора: кнопки внизу.
- [ ] Messages, UI-тесты, contracts.md.
- [ ] Передать результат на независимую проверку.

Ближайший шаг: открыть `container-survey-detail-view.xml` и контракт в
contracts.md.
Препятствия: нет
