...
Статус: todo — по [fixes/F01.md](fixes/F01.md)
...
- [x] Проверка 001: критерии C1–C6 подтверждены в браузере и тестами.
- [ ] Убрать из комментария XML ссылку на решение пользователя
      ([fixes/F01.md](fixes/F01.md)).

Ближайший шаг: исполнитель правит комментарий по
[fixes/F01.md](fixes/F01.md) и передаёт итерацию 2 на повторную проверку.
Препятствия: нет
