...
Статус: ready_for_verify — по [fixes/F01.md](fixes/F01.md)
...
Ближайший шаг: повторная проверка [F01](fixes/F01.md) — поиск по изменённым
файлам T12 без совпадений, `./gradlew :app:compileJava` и `spotlessApply`;
