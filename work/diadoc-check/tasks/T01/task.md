...
- [ ] Исправление [F01](fixes/F01.md): резолв настроек по коду контрагента
      (по [Q02](../../questions/Q02.md)), новая итерация на проверку.

Ближайший шаг: `task-execute` с [fixes/F01.md](fixes/F01.md)
Препятствия: нет
