...
Статус: ready_for_verify — исправление [F01](fixes/F01.md), итерация 2
...
- [x] Исправление [F01](fixes/F01.md): резолв настроек по коду контрагента
      (по [Q02](../../questions/Q02.md)), итерация 2 передана на проверку.

Ближайший шаг: `task-verify` с этим файлом и [fixes/F01.md](fixes/F01.md) —
проверить F01.1 по разделу «Повторная проверка» исправления
Препятствия: нет
